...
const LoginRegisterForm = ({ option, handleOnChange, handleOnSubmit, emailError }) => {
    ...
    <div className='formContainer'>
      <form className="form_container" onSubmit={handleOnSubmit}>
        <div className="title_container">
          <p className="title">{option === "register" ? "Registrate con tu correo" : "Inicia sesión con tu cuenta"}</p>
