    ...
    <div className='formContainer'>
      <form className="form_container">
        ...
        <div className="input_container">
          <label className="input_label" for="email_field">Correo</label>
          ...
          <input placeholder="Introduce tu correo ..." title="Inpit title" name="input-name" type="email" className="input_field" id="email_field" />
        </div>
        <div className="input_container">
          <label className="input_label" for="password_field">Contraseña</label>
          <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className="icon">
          ...
          <input placeholder="Introduce tu contraseña ..." title="Inpit title" name="input-name" type="password" className="input_field" id="password_field" />
        </div>
        ...
        <span className="note">¿No tienes cuenta? No pasa nada, dale al botón para registrate</span>
